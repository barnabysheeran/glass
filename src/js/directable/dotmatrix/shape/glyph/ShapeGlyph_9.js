...
export default class ShapeGlyph_9 extends Shape {
	#LOG_LEVEL = 6;
    ...
    #positionGridGlyphs = [
        ...
        vec2.fromValues(0, 1),                                             vec2.fromValues(3, 1),
                               vec2.fromValues(1, 2), vec2.fromValues(2, 2), vec2.fromValues(3, 2),
                                                                           vec2.fromValues(3, 3),
                               vec2.fromValues(1, 4), vec2.fromValues(2, 4),
    ];
    /* eslint-enable */
	...
	constructor(
		...
		ApplicationLogger.log(`ShapeGlyph_9`, this.#LOG_LEVEL);
