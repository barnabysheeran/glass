...
export default class ShapeGlyph_G extends Shape {
	#LOG_LEVEL = -1; // 6;
    ...
    #positionGridGlyphs = [
        ...
        vec2.fromValues(0, 1),
        vec2.fromValues(0, 2),                       vec2.fromValues(3, 2), vec2.fromValues(4, 2),
	...
	constructor(
		...
		ApplicationLogger.log(`ShapeGlyph_G`, this.#LOG_LEVEL);
