...
export default class ShapeGlyph_N extends Shape {
	#LOG_LEVEL = -1; // 6;

	/* eslint-disable */
    #positionGridGlyphs = [
        vec2.fromValues(0, 0),                                             vec2.fromValues(3, 0),
        vec2.fromValues(0, 1), vec2.fromValues(1, 1),                       vec2.fromValues(3, 1),
        vec2.fromValues(0, 2),                       vec2.fromValues(2, 2), vec2.fromValues(3, 2),
	...
	constructor(
		...
		ApplicationLogger.log(`ShapeGlyph_N`, this.#LOG_LEVEL);
