...
export default class ShapeGlyph_Q extends Shape {
	#LOG_LEVEL = 6;
    ...
    #positionGridGlyphs = [
        ...
        vec2.fromValues(0, 3),                       vec2.fromValues(2, 3), vec2.fromValues(3, 3),
                              vec2.fromValues(1, 4), vec2.fromValues(2, 4), vec2.fromValues(3, 4),
    ];
    /* eslint-enable */
	...
	constructor(
		...
		ApplicationLogger.log(`ShapeGlyph_Q`, this.#LOG_LEVEL);
