...
export default class ShapeGlyph_K extends Shape {
	#LOG_LEVEL = 6;

	/* eslint-disable */
    #positionGridGlyphs = [
        vec2.fromValues(0, 0),                                            vec2.fromValues(3, 0),
        vec2.fromValues(0, 1),                       vec2.fromValues(2, 1),
        vec2.fromValues(0, 2), vec2.fromValues(1, 2),
        vec2.fromValues(0, 3),                       vec2.fromValues(2, 3),
	...
	constructor(
		...
		ApplicationLogger.log(`ShapeGlyph_K`, this.#LOG_LEVEL);
